            ...
            <div class="zhanghuguanli_liebiao">
             ...
             <!--      这块数据需要修改，下拉改成了按钮-->
                        <!--    <select  name="type" id="type">
                            ...
                            <input id="" type="radio" class="" name="type"  placeholder="" value="1" >
                                <span>个人发布</span>
                            </div>
                            
                            <div class="shangjia_fabu_radio">
                            <input id="" type="radio" class="" name="type"  placeholder="" value="2" >
                                <span>商家发布</span>
                            </div> 
           <!--      这块数据需要修改，下拉改成了按钮end-->                
                        ...
                        <div for="" class="shangjia_fabu_left_title">
                            ...
                            <select  name="brand" id="brand">
                                ...
                                <?php if(is_array($brand)): $i = 0; $__LIST__ = $brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["label"]); ?>">
                                        <?php echo ($vo["label"]); ?>
                        ...
                        <li>
                            ...
                            <input id="num" type="text" class="" name="num" tabindex="" maxlength=""
                                   autocomplete="" placeholder="请输入您的数量">
                        </li>
                        <li>
                            <div for="" class="shangjia_fabu_left_title">
                                手机:
                            ...
                            <input id="phone" type="text" class="" name="mobile" tabindex="" maxlength=""
                                   autocomplete="" placeholder="" value="<?php echo ($userinfo["mobile"]); ?>">
                        ...
                        <li>
                            ...
                            <input id="qq" type="text" class="" name="qq" tabindex="" maxlength=""
                                   autocomplete="" placeholder="" value="<?php echo ($userinfo["qq"]); ?>">
                        ...
                        <li>
                            ...
                            <input id="weixin" type="text" class="" name="weixin" tabindex="" maxlength=""
                                   autocomplete="" placeholder="" value="<?php echo ($userinfo["weixin"]); ?>">
                        ...
                        <li>
                            ...
                            <div class="shangchuan_photo upload_pic">
                                ...
                                <div class="fabu_zhaopian ">
                                    <button type="button" class="btn btn-primary genggaitouxiang_btn fabu_zhaopian_btn"  data-toggle="modal" data-target="#avatar-modal" style="margin: 10px;">
                                        上传照片
                                    </button>
                        ...
                        <li>
                            ...
                            <span class="agress_checked">
                                <input type="checkbox" id="choose" value="1" checked="true" >&nbsp我已阅读<span class="hh" >《发布条款》</span>
                            </span>
...
<div class="ttcc" >
    <a class="ttt_close" >
        <img src="/themes/xiefu/Public/images/admin_close.png">
    </a>
...
// 选择-出现市
        $('.ProvinceSelect').change(function(){
            ...
            $.ajax({
                type:"get",
                url: '<?php echo U("report/reportgoods/region");?>',
                data:  {'pid':sheng_id},
                dataType:"json",
                success:function(data){
...
<script type="text/javascript">
    ...
    $(".avatar-save").on("click", function() {
        ...
        var a=$(".avatar-preview img").attr("src");
...
<script>
    $("#submit").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo U('report/reportgoods/donewreport');?>",
            data:  {'brand':brand,'qq':qq,'weixin':weixin,'mobile':mobile,'title':title,'size':size,'num':num,'province':province,'city':city,'photos':data['img'],'type':type},
            async: false,
            success: function(data) {
                ...
                if(data['status']=='1'){
                    layer.alert("发布成功",function(){
                        window.location.href="<?php echo U('report/reportgoods/reportlist');?>";
                    });
