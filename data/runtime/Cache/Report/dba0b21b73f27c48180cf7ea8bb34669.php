        ...
        <div class="huowu_you">
            <div class="huowu_you_liebiao">
                ...
                <ul>
                    <li id="all" <?php if($_GET['type']=='all'||empty($_GET['type'])) echo 'class="check"'?>>
                        <a href="<?php echo U('report/reportgoods/reportlist');?>&type=all">全部</a>
                    </li>

                    <li id="on" <?php if($_GET['type']=='on') echo 'class="check"'?>>
                        <a href="<?php echo U('report/reportgoods/reportlist');?>&type=on">个人发布中的报货</a>
                    </li>
                    <li id="business" <?php if($_GET['type']=='business') echo 'class="check"'?>>
                        <a href="<?php echo U('report/reportgoods/reportlist');?>&type=business">商家发布中的报货</a>
                    </li>
                    <li id="back" <?php if($_GET['type']=='back') echo 'class="check"'?>>
                        <a href="<?php echo U('report/reportgoods/reportlist');?>&type=back">被退回的报货</a>
                    </li>

                    <li id="off" <?php if($_GET['type']=='off') echo 'class="check"'?>>
                        <a href="<?php echo U('report/reportgoods/reportlist');?>&type=off">已下架的报货</a>
                    </li>
            ...
            <div class="huowu_you_shangpin" id="huowu_you_shangpin_all" style="display: block">
                <ul>
                    ...
                    <?php if(is_array($reportgoods)): $i = 0; $__LIST__ = $reportgoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                       <!-- <div class="huowu_checkbox">
                        ...
                        <div class="huowu_zi">
                            ...
                            <p class="huowu_zi_h1"><?php echo ($vo["title"]); ?></p>

                            <!-- <p class="huowu_zi_h2"><?php echo ($vo["memo"]); ?></p> -->

                            <p class="huowu_zi_h3"></p>

                            <p class="huowu_zi_h4"><?php echo ($vo["add_time"]); ?></p>
                        </div>
                        </div>

                        <div class="huowu_size">
                            <p class="huowu_size_p"><?php echo ($vo["size"]); ?></p>
                        </div>
                        ...
                        <div class="huowu_zhuangtai">
                            <div class="huowu_zhuangtai_juzhong">
                                ...
                                <p>
                                <h2><?php echo ($vo["sh_memo"]); ?></h2>
                                </p>
                            </div>
                        </div>
                        <div class="huowu_caozuo_all">
                            <?php if($vo['status']==1){ ?>
                            <a  data="<?php echo ($vo["id"]); ?>" class="huowu_caozuo off" >
                                下架
                            </a>
                            <?php } ?>
                            <?php if($vo['status']==2||$vo['status']==0){ ?>
                            <a href="<?php echo U('report/reportgoods/edit');?>&id=<?php echo ($vo["id"]); ?>" class="huowu_caozuo">
                                修改
                            </a>
                            <?php } ?>
                            <?php if($vo['status']==3){ ?>
                            ...
                            <div class="youhuo">
                                <?php if($vo['sum']==0){ ?>
                                    <a>
                                <?php }else{ ?>
                                <a href="<?php echo U('report/reportgoods/detail');?>&id=<?php echo ($vo["id"]); ?>">
                                <?php } ?>
                                    共<?php echo ($vo["sum"]); ?>个商家有货>
                                </a>
...
<!-- <iframe src="/themes/xiefu/Public/footer.html" scrolling="no" width="100%" height="115" frameborder="no" style="float: left;margin-top: 30px;background: #f5f5f5;"></iframe> -->
    ...
    $(function () {
        ...
        $('.list_delete').click(function(){
            ...
            layer.confirm('确定删除吗？', {
                ...
                $.ajax({
                    type:"get",
                    url: "<?php echo U('report/reportgoods/delete');?>",
                    data:  {'id':id},
                    dataType:"json",
                    success:function(data){
                        console.log(data);
        ...
        $('.on').click(function(){
            ...
            layer.confirm('确定恢复吗？', {
                ...
                $.ajax({
                    type:"get",
                    url: "<?php echo U('report/reportgoods/on');?>",
                    data:  {'id':id},
                    dataType:"json",
                    success:function(data){
                        console.log(data);
