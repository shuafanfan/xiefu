        ...
        <div class="huowu_you">
            <div class="huowu_you_liebiao">
                ...
                <ul>
                    <li <?php if($_GET['type']=='all'||empty($_GET['type'])) echo 'class="check"'?>>
                        <a href="<?php echo U('report/reportgoods/newrecord');?>&type=all">全部</a>
                    </li>

                    <li <?php if($_GET['type']=='on') echo 'class="check"'?>>
                        <a href="<?php echo U('report/reportgoods/newrecord');?>&type=on">发布中的新款</a>
                    </li>

                    <li <?php if($_GET['type']=='off') echo 'class="check"'?>>
                        <a href="<?php echo U('report/reportgoods/newrecord');?>&type=off">已下架的新款</a>
                    </li>
                </ul>
                <!-- <span class="fabuxianzhi">
                   <a href="/themes/xiefu/Public/">发布闲置</a>
                </span>
            ...
            <div class="huowu_you_shangpin" id="huowu_you_shangpin_all" style="display: block">
                <ul>
                    ...
                    <?php if(is_array($newstyle)): $i = 0; $__LIST__ = $newstyle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        ...
                        <div class="huowu_caozuo_all">
                            ...
                            <a href="<?php echo U('report/reportgoods/editnew');?>&id=<?php echo ($vo["id"]); ?>" class="huowu_caozuo">
                                修改
                            </a>
                            <?php } ?>
                            <?php if($vo['status']==3){ ?>
                            ...
                            <a data="<?php echo ($vo["id"]); ?>" class="huowu_caozuo delete" id="delete">
                                彻底删除
                            </a>
            ...
            id=$(this).attr('data');
                    layer.confirm('确定删除吗？', {
                      btn: ['是','否'] //按钮
                        ...
                        $.ajax({
                            type:"get",
                            url: "<?php echo U('report/reportgoods/newdelete');?>",
                            data:  {'id':id},
                            dataType:"json",
                            success:function(data){ 
                             console.log(data);
            ...
            id=$(this).attr('data');
                    layer.confirm('确定下架吗？', {
                      btn: ['是','否'] //按钮
                        ...
                        $.ajax({
                            type:"get",
                            url: "<?php echo U('report/reportgoods/newoff');?>",
                            data:  {'id':id},
                            dataType:"json",
                            success:function(data){ 
                             console.log(data);
            ...
            id=$(this).attr('data');
                    layer.confirm('确定恢复吗？', {
                      btn: ['是','否'] //按钮
                        ...
                        $.ajax({
                            type:"get",
                            url: "<?php echo U('report/reportgoods/newon');?>",
                            data:  {'id':id},
                            dataType:"json",
                            success:function(data){ 
                             console.log(data);
