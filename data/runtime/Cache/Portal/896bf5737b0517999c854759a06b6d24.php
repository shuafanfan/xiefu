...
<div class="container">
    <div class="xingzhi">
        ...
        <ul>
            <li><a href="<?php echo U('portal/page/newstyle');?>&brand=">全部</a></li>
            ...
            <div class="xingzhi" id="zhankaineirong">
                <ul>
                    <li><a href="/themes/xiefu/Public/#"></a></li>
                </ul>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
            <a href="<?php echo U('portal/page/business');?>&bid=<?php echo ($vo["bid"]); ?>">
                ...
                <div class="chanpinzi">
                    ...
                    <h1><?php echo ($vo["brands"]); ?> <?php echo ($vo["title"]); ?></h1>
                    ...
                    <p>
                        <a href="tencent://message/?uin=<?php echo ($vo["qq1"]); ?>&amp;Site=0594666.com&amp;Menu=yes">
                        <span class="brand_erweima_div">
                            <img src="/themes/xiefu/Public/images/qq.png">
                     <!--隐藏的二维码-->
                     ...
                     <!--隐藏的二维码-->   
                        ...
                        <span class="youduiqi brand_erweima_div weixin-QR-code">
                    <!--隐藏的二维码-->
                       <span class="brand_erweima brand_erweima2">
                            <img src="/themes/xiefu/Public/images/erweima.png">                
                        </span>
                     <!--隐藏的二维码-->  	
                            <img src="/themes/xiefu/Public/images/weixin.png">
               
                           <span class="color_green">微信</span>
...
<script>
    $(function () {
        $(".xq_bag").append('<div class="xq_move" style="height: 3px; left:330px; width: 140px; bottom: 0px; background: red;"></div>' );
        $.fn.xq_navbar = function( _option ){
            ...
            this.line=function(){
                ...
                this.navbar.on('mouseout',function(){
                    xq_li.css({"color":"#fff"});
                    movelist.css({"left":"330px","width":"140px"});
                });
            };
