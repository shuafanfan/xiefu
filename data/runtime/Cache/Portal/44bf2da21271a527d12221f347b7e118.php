...
<head>
    <meta charset="UTF-8">
    <title>搜索结果</title>
    <link rel="stylesheet" href="/themes/xiefu/Public/css/huoyuanjieguo.css">
    <link rel="stylesheet" href="/themes/xiefu/Public/css/header.css">
...
<div class="container">
    ...
    <div class="chanpin_chaxun">
        共找到<span> <?php echo ($sum); ?> </span>件与<a href="/themes/xiefu/Public/#"> <?php echo isset($_POST['keyword'])?$_POST['keyword']:$_GET['keyword'] ?> </a>相关的结果
...
<script type="text/javascript">
    $(function(){
        $.fn.xq_navbar = function( _option ){
            ...
            this.line=function(){
                var move=$("<div/>",{"class":"xq_move"}).css({ "height":"3px","left":"420px","width":"140px"}).appendTo(_self);
                switch(defaults.type){
                    ...
                    case "line":
                        move.css({"bottom":"0px"});
                        $("<div/>",{"class":"xq_move"}).css({ "bottom":"0px","height":"5px","left":"420px","width":"140px"}).appendTo(_self);
                        break;
                }
                var width;
                ...
                this.navbar.on('mouseout',function(){
                    xq_li.css({"color":"#fff"});
                    movelist.css({"left":"420px","width":"140px"});
                });
            };
