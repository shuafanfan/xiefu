                    ...
                    <ul>
                      ...
                      <!--      这块数据需要修改，下拉改成了按钮-->
                        <!--    <select  name="type" id="type">
                            ...
                            <input id="type" type="radio" class="" name="type"  placeholder="" value="1" >
                                <span>个人发布</span>
                            </div>
                            <?php if($user['user_type']==3){ ?>
                            <div class="shangjia_fabu_radio">
                            <input id="type" type="radio" class="" name="type"  placeholder="" value="2" >
                                <span>商家发布</span>
                            </div> 
                            <?php } ?>
           <!--      这块数据需要修改，下拉改成了按钮end--> 
                        ...
                        <li>
                            ...
                            <input id="comment" type="text" class="" name="comment" tabindex="" maxlength=""
                                   autocomplete="" placeholder="请选择输入您的卖点">
                        </li>
                        ...
                        <li>
                            ...
                            <input id="price" type="text" class="" name="price" tabindex="" maxlength=""
                                   autocomplete="" placeholder="请输入您的价格">
                        </li>
                        <li>
                            <div for="" class="shangjia_fabu_left_title">
                                手机:
...
<script>
    $("#submit").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo U('zaza/zazamarket/donewzaza');?>",
            data:  {'sort':brand,'qq':qq,'weixin':weixin,'mobile':mobile,'title':title,'comment':comment,'price':price,'province':province,'city':city,'photos':data['img'],'type':type},
            async: false,
            success: function(data) {
                if(data['status']=='1'){
                    layer.alert("发布成功",function(){
                        window.location.href="<?php echo U('zaza/zazamarket/zazalist');?>";
                    });
                }
                if(data['status']=='0'){
                    layer.alert("发布失败");
